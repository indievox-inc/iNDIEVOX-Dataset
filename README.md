...
If you want to extract features from your songs, you can use iNDIEVOX to extract features for you. But before uploading songs to iNDIEVOX, **please make sure that you have the rights to upload the songs**.

#### Step 2. Set the songs public.

#### Step 3. Wait 1 - 3 days for iNDIEVOX extracting features.

#### Step 4. Done, you can use iNDIEVOX MIR Open API to check out the results.
